...
const defined = defineNestedCrudResource<
  "Vultr.BlockStorageSnapshot",
  BlockStorageSnapshotProps,
  BlockStorageSnapshotAttributes
>({
  type: "Vultr.BlockStorageSnapshot",
  stables: ["id"],
  idAttribute: "id",
  parentIdAttribute: "blockStorageId",
  wrapKey: "block_snapshot",
  listKey: "block_snapshots",
...
export const BlockStorageSnapshot = defined.Resource;
export const BlockStorageSnapshotProvider = defined.Provider;
