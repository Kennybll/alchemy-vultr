...
export type SnapshotFromUrl = Resource<
 ...
 * @resource
 */
export const SnapshotFromUrl = Resource<SnapshotFromUrl>(
  "Vultr.SnapshotFromUrl",
);

export const SnapshotFromUrlProvider = () =>
  Provider.succeed(
    SnapshotFromUrl,
    SnapshotFromUrl.Provider.of({
      stables: ["id"],
