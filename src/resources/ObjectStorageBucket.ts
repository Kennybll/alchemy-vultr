...
export type ObjectStorageBucket = Resource<
 ...
 * @resource
 */
export const ObjectStorageBucket = Resource<ObjectStorageBucket>(
  "Vultr.ObjectStorageBucket",
);

export const ObjectStorageBucketProvider = () =>
  Provider.succeed(
    ObjectStorageBucket,
    ObjectStorageBucket.Provider.of({
      stables: ["id"],
      list: () => Effect.succeed([]),
