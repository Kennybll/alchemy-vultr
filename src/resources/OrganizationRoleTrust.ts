...
const defined = defineCrudResource<
  "Vultr.OrganizationRoleTrust",
  OrganizationRoleTrustProps,
  OrganizationRoleTrustAttributes
>({
  type: "Vultr.OrganizationRoleTrust",
  stables: ["id"],
  idAttribute: "id",
...
export const OrganizationRoleTrust = defined.Resource;
export const OrganizationRoleTrustProvider = defined.Provider;
