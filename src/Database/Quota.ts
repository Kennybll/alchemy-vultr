...
const defined = defineNestedCrudResource<
  "Vultr.Database.Quota",
  DatabaseQuotaProps,
  DatabaseQuotaAttributes
>({
  type: "Vultr.Database.Quota",
  aliases: ["Vultr.DatabaseQuota"],
  stables: ["id"],
  idAttribute: "id",
...
export const Quota = defined.Resource;
export const QuotaProvider = defined.Provider;
