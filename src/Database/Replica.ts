...
const defined = defineNestedCrudResource<
  "Vultr.Database.Replica",
  DatabaseReplicaProps,
  DatabaseReplicaAttributes
>({
  type: "Vultr.Database.Replica",
  aliases: ["Vultr.DatabaseReplica"],
  stables: ["id"],
  idAttribute: "id",
...
export const Replica = defined.Resource;
export const ReplicaProvider = defined.Provider;
