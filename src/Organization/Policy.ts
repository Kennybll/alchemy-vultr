...
const defined = defineCrudResource<
  "Vultr.Organization.Policy",
  OrganizationPolicyProps,
  OrganizationPolicyAttributes
>({
  type: "Vultr.Organization.Policy",
  aliases: ["Vultr.OrganizationPolicy"],
  stables: ["id"],
  idAttribute: "id",
  listPath: "/policies",
  listKey: "policies",
...
export const Policy = defined.Resource;
export const PolicyProvider = defined.Provider;
